...
var difficulty_colors = [make_color_rgb(127,191,255),make_color_rgb(127,255,127),make_color_rgb(255,127,127),make_color_rgb(191,127,255),make_color_rgb(127,127,255)]
for(var i = 0; i < op_length_y; i++) {
	scribble_object[i] = scribble(option[i])
		...
		.gradient(difficulty_colors[i],1)
		.wrap(640)
		.draw(x,y + (op_space * i))
}

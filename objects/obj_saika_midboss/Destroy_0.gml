var inst = item_CreateItemA1(spr_life_item,x,y,0,2);
...
for (var i = 0; i < array_length(global.player_stats); i++) {
	system_AddScore(round(35000),i);
}
if room != room_debug { scr_create_camera("STAGE_04_NIGHT"); }
inst = instance_create_depth(x,y,-1000,obj_defeated_boss);
inst.index_sprite = spr_saika_defeat;
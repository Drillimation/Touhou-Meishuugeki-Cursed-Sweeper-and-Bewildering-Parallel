...
if entered == true {
	...
	if count >= 50 and count < 200 {
		if count mod 8 - global.main_stats.difficulty == 0 {
			...
			shot_CreateShotA1(x,y,1,angleT + irandom_range(-15,15),choose(spr_danmaku_pellet,spr_danmaku_ball_s1,spr_danmaku_ball_m1),5,0);
		}
		if count mod 40 == 0 {
			sound_ObjSound_Play(se_kira00);
			var angleT = point_direction(x,y,obj_player.x,obj_player.y);
			shot_CreateShotA1(x,y,2,angleT,spr_danmaku_ball_l,5,0);
		}
	}
	if count == 200 {
		speed = 1;

...
*/
var load_file2 = scr_json_load_file("cutscenes/CHAR_REIMU_stage_4_night_prebattle" + string(global.suf) + ".json");
var cutscene = scr_json_load_file("cutscenes/CHAR_REIMU_stage_4_night_prebattle.json")

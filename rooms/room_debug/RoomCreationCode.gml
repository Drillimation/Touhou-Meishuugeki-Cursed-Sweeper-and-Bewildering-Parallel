...
*/
var load_file2 = scr_json_load_file("cutscenes/CHAR_KAGUYA_stage_2_night_midbattle" + string(global.suf) + ".json");
var cutscene = scr_json_load_file("cutscenes/CHAR_KAGUYA_stage_2_night_midbattle.json")

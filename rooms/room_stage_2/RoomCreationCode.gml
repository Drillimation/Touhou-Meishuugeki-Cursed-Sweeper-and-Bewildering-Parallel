...
inst.stage_start_number = struct_get(_load_data.stage_start_number,"STAGE_02_" + string(global.main_stats.time_of_day));
inst.stage_name = struct_get(_load_data.stage_names,"STAGE_02_" + string(global.main_stats.time_of_day));
inst.stage_bgm = "bgm/stage_02.it";

scr_create_camera("STAGE_02_" + string(global.main_stats.time_of_day) + "_MID");

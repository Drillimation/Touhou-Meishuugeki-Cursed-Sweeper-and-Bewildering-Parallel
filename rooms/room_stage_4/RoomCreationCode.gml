...
inst.stage_start_number = struct_get(_load_data.stage_start_number,"STAGE_04_DAY");
inst.stage_name = struct_get(_load_data.stage_names,"STAGE_04_DAY");
inst.stage_bgm = "bgm/stage_04.it";

scr_create_camera("STAGE_04_DAY_MID");

...
inst.stage_start_number = struct_get(_load_data.stage_start_number,"STAGE_06_DAY");
inst.stage_name = struct_get(_load_data.stage_names,"STAGE_06_DAY");
inst.stage_bgm = "bgm/stage_06.it";

scr_create_camera("STAGE_06_DAY_MID");

...
inst.stage_start_number = struct_get(_load_data.stage_start_number,"STAGE_07");
inst.stage_name = struct_get(_load_data.stage_names,"STAGE_07");
inst.stage_bgm = "bgm/stage_extra.it";

scr_create_camera("STAGE_07_MID");

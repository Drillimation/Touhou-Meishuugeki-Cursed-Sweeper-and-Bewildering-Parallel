...
inst.stage_start_number = struct_get(_load_data.stage_start_number,"STAGE_08");
inst.stage_name = struct_get(_load_data.stage_names,"STAGE_08");
inst.stage_bgm = "bgm/stage_phantasm.it";

scr_create_camera("STAGE_08_MID");
